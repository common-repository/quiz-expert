...
<div class="quexp-q"><?php echo wp_kses_post( $q_sl.".&nbsp;&nbsp;&nbsp;");?><a id="qname_tf_val<?php echo esc_attr( $q_id);?>" style="color:#393939"><?php echo wp_kses_post($question )?></a>&nbsp;&nbsp;
</div>
...
<a href="#TB_inline?width=600&height=550&inlineId=edit_question_popup" title="Edit Question" class="thickbox" onclick="quexp_edit_tf_question_button(<?php echo esc_attr( $q_id); ?>);"> 
...
<br/>
<div>Answer: <a class="row-title" id="answer_tf_val<?php echo esc_attr( $q_id);?>"><?php echo wp_kses_post( $answer);?></a></div>
<?php if ($explaination !=""){ ?>
<div id="explain_div<?php echo esc_attr( $q_id);?>">Explaination: <a class="row-title" id="explaination_tf_val<?php echo esc_attr( $q_id);?>"><?php echo wp_kses_post( $explaination);?></a></div>
<?php } else {  ?>
